      ...
      <div className="space-y-5 py-1">
        <div>
          ...
          <Paragraph type="secondary" className="mb-0!">
            Thiết lập tên rạp và địa chỉ hiển thị dùng cho các luồng in vé và thông tin nhận diện
            chi nhánh.
          </Paragraph>
        </div>
          ...
          <Card className="h-full">
            <div className="mb-4 flex items-start gap-3">
              ...
              <div>
                ...
                <Text type="secondary">
                  Nên dùng đúng tên rạp và địa chỉ vận hành để đồng bộ trên vé in và chứng từ nội
                  bộ.
                </Text>
              </div>
            </div>
