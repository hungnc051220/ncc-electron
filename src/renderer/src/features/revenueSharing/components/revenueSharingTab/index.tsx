...
import { exportRevenueSharingExcel } from "../ExportExcel";
import { exportRevenueSharingListExcel } from "../ExportListExcel";
import Filter from "../Filter";
import RevenueSharingDialog from "./RevenueSharingDialog";

interface RevenueSharingTabProps {
  onActionsChange?: (actions: ReactNode) => void;
}

const RevenueSharingTab = ({ onActionsChange }: RevenueSharingTabProps) => {
...
export default RevenueSharingTab;
