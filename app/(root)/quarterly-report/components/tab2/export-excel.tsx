...
const ExportRevenueExcelButton = ({
  ...
  const exportExcel = async () => {
    ...
    ws.getCell(1, 1).value =
      `BÁO CÁO DOANH THU VÉ THEO TỪNG LOẠI VÉ - THÁNG ${dayjs(fromDate).quarter()}/${dayjs(fromDate).year()}`;
    ...
    ws.getCell(headerStartRow, priceGroupStartCol).value =
      "Loại giá vé (Đơn vị tính: 1.000đ)";
